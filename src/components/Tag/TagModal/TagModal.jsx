...
const TagModal = (props) => {
    const handleFormSubmit = (e) => {
        ...
        if( data.name == '' ){
            ...
            axios.post("http://localhost:5050/tags", {
                ...
                axios.get('http://localhost:5050/tags').then(res => props.updateTag(res.data));
                props.hide();
    ...
    const handleTagDelete = () => {
        axios.delete('http://localhost:5050/tags/' + props.dataId).then(res => {
            axios.get('http://localhost:5050/tags').then(res => props.updateTag(res.data));
            props.hide();
    ...
    const handleFormUpdate = (e) => {
        ...
        if( data.name == '' ){
            ...
            axios.patch("http://localhost:5050/tags/" + props.dataId.id, {
                name: data.name
            }).then(res => {
            ...
            <Modal type={props.type} show={props.show} onHide={props.hide} centered>
                ...
                <Modal.Body>
                    ...
                    <div className='d-flex justify-content-end'>
                        ...
                        <Button onClick={handleTagDelete} variant='danger'>Delete</Button>
                    </div>
                </Modal.Body>
            </Modal>
        );

    } else if(props.type == 'tag-edit'){
